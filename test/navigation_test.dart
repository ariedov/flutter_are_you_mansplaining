...
void main() {
  ...
  test('Did she ask to explain error', () {
    ...
    expect(() => navigator.navigate(screen, IHaveMoreExperience()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, AboutTheSameExperience()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, SheHasMoreExperience()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, SheIsAnExpert()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, SheAgreedToExplanation()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, SheRefusedExplanation()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, IDidNotAskPermission()),
        throwsA(TypeMatcher<InvalidActionException>()));
  });
  ...
  test('Do you have more experience screen error', () {
    ...
    expect(() => navigator.navigate(screen, Yes()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, No()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, SheAgreedToExplanation()),
        throwsA(TypeMatcher<InvalidActionException>()));
    expect(() => navigator.navigate(screen, SheRefusedExplanation()),
